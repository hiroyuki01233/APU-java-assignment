...
public class ManagerListPage extends JPanel {
    ...
    private JList<BaseUser> list;
    private DefaultListModel<BaseUser> listModel = new DefaultListModel<>();
    private List<BaseUser> baseUsers;

    private void onLoadManagers() {
        try {
            this.authController = new AuthController();
            this.baseUsers = this.authController.getAllManagers();
            this.listModel.clear();
            for (BaseUser user : this.baseUsers) {
                this.listModel.addElement(user);
            }
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(mainFrame, "Error loading managers: " + ex.getMessage());
        }
    }
    ...
    public ManagerListPage(MainFrame frame) {
        ...
        JLabel titleLabel = new JLabel("Manager List");
        ...
        list.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public java.awt.Component getListCellRendererComponent(JList<?> list, Object value, int index,
                ...
                if (value instanceof BaseUser user && user.getUserType().equals("manager")) {
                    String showingText =
        ...
        JButton registerButton = createStyledButton("Register New Manager");
        registerButton.addActionListener(e -> mainFrame.switchTo("ManagerRegisterPage"));

        JButton editButton = createStyledButton("Edit Selected Manager");
        editButton.addActionListener(e -> {
            BaseUser selected = list.getSelectedValue();
            if (selected != null) {
                ManagerEditPage editPage = new ManagerEditPage(mainFrame, selected);
                mainFrame.addPanel("ManagerEditPage", editPage);
                mainFrame.switchTo("ManagerEditPage");
            } else {
                JOptionPane.showMessageDialog(mainFrame, "Select a manager runner to edit.");
            }
        });
