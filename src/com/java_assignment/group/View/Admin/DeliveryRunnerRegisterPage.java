...
public class DeliveryRunnerRegisterPage extends JPanel {
    ...
    public DeliveryRunnerRegisterPage(MainFrame frame) {
        ...
        JLabel titleLabel = new JLabel("Register New Delivery Runner");
        titleLabel.setFont(TITLE_FONT);
        titleLabel.setForeground(Color.WHITE);
        titleLabel.setAlignmentX(CENTER_ALIGNMENT);

        JLabel subtitleLabel = new JLabel("Create a new delivery runner account");
        ...
        addFormField("First Name:", firstNameField, formPanel);
        addFormField("Last Name:", lastNameField, formPanel);
        ...
        JButton registerButton = createStyledButton("Register Delivery Runner", SUCCESS_COLOR);
